    ...
    observeEvent(input$instructions, {
        showModal(modalDialog(
            ...
            tags$ol(
                ...
                tags$li("Mark the the pattern in each of the four quadrants, starting at the top of the right corner and then flipping it horizontally and vertically as you go around."),
                tags$li("Cut it out"),
